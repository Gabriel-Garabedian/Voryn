    ...
    <div className="animate-slide-up">
      ...
      <div className="px-4 mb-4">
        <div className="f-card p-4 flex items-center gap-4">
          ...
          {student.spotify_url && (
            <a href={student.spotify_url} target="_blank" rel="noopener noreferrer"
              title="Ver playlist de treino no Spotify"
      ...
      if (data) {
        ...
        trainerService.getStudents(data.id).then(({ data: s }) => {
          ...
          const normalized = (s || []).map(row => ({
            ...
            spotify_url: row.users?.spotify_url ?? row.spotify_url ?? null,
          }))
